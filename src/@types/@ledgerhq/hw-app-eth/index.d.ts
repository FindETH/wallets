declare module '@ledgerhq/hw-app-eth' {
  ...
  export default class EthereumApp<Descriptor> {
     ...
     *   all transports.
     */
    constructor(transport: Transport<Descriptor>, scrambleKey?: string);
     ...
     */
    provideERC20TokenInformation(tokenInfo: TokenInfo): Promise<boolean>;
     ...
     */
    signTransaction(path: string, rawTransactionHex: string): Promise<Signature>;
     ...
     * @return {Promise<Signature>} A Promise with the Signature.
     */
    signPersonalMessage(path: string, messageHex: string): Promise<Signature>;
  }
}
